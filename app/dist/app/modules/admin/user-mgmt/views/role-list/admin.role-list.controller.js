(function (angular) {
  ...
  function AdminRoleListController($rootScope, $scope, RoleModel, $sessionStorage, Pageable, modalService) {
    var vm = this;
    vm.firstLoad = true;
    ...
    vm.page = {
      content: [],
      _queryParams: $sessionStorage.roleList || {
        _page: 0,
    ...
    vm.actions = {
      deleteRole: function (role) {
        modalService.confirm({
          title: 'ADMIN.USER_MGMT.ROLES.OPTIONS.DELETE.MODAL.TITLE',
          text: 'ADMIN.USER_MGMT.ROLES.OPTIONS.DELETE.MODAL.TEXT',
          translationContext: {userCount: role.userCount},
          close: {title: 'YES'},
          dismiss: {title: 'NO'}
    ...
    function initialLoad() {
      ...
      return RoleModel.pagedQuery(pageable, vm.page._queryParams).then(function (result) {
        vm.page = result;
        vm.page._queryParams._page = result.number;
        $sessionStorage.roleList = vm.page._queryParams;
      }).finally(function () {
