(function () {
  ...
  angular
      .module('commons.ui')
      .factory('selectFactoryModel', function ($timeout, modalService, $q) {
        return function (config) {
          return {
            ...
            templateUrl: 'app/commons/ui/components/ui-select/select-factory-model' + (config.multiple ? '.multiple' : '') + '.html',
            link: function (scope, elem, attrs, ctrl) {
              ...
              scope.$watch('data.ngModel', function (newVal) {
              ...
              function selectRefresh(search, reset) {
                doRefresh(search, reset).then(function (response) {
                  ...
                  if (config.multiple && scope.data.ngModel && angular.isArray(scope.data.ngModel)) {
